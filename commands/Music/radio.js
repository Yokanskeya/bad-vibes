...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    else if (Number([args[0]]) > 160 && Number(args[0]) <= 171) args2 = radios.Asian.Indonesia[Number(args[0]) - 160 - 1].split(` `);
    else if (Number([args[0]]) > 171 && Number(args[0]) <= 189) args2 = radios.OTHERS.request[Number(args[0]) - 170 - 1].split(` `);
